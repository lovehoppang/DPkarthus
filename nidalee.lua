...
cfg.combo:addParam("combo","Combo key",SCRIPT_PARAM_ONKEYDOWN, false, string.byte('T'))
...
self.spells = {
	humanQ = {range = 1500, width = 80, speed = 1300, delay = 0.125, cooldown = 0, level = 0, mana = 0},
